...
if __name__=='__main__':
    res1 = parse_function_call1("FUNCTION_CALL:add|a=5|b=3")
    print("res1: ", res1)
    res2 = parse_function_call1("FUNCTION_CALL:strings_to_chars_to_int|input.string=INDIA")
    print("res2: ", res2)
    res3 = parse_function_call1("FUNCTION_CALL:int_list_to_exponential_sum|input.int_list=[73,78,68,73,65]")
    print("res3: ", res3)