...
async def main(user_input: str, user_preference:str):
    try:
                    ...
                    async with ClientSession(read, write) as session:
                        ...
                        try:
                            ...
                            while step < max_steps:
                                ...
                                perception = extract_perception(user_input, user_preference)
...
if __name__ == "__main__":
    ...
    user_preference = input("Please provide your preference: ")
    asyncio.run(main(query, user_preference))
